...
adminConfigSchema.statics.seedDefaults = async function() {
  const defaults = [
    ...
    { key: 'referral_signup_bonus_referrer', value: 10, category: 'referral', description: 'Signup bonus for referrer (INR)' },
    { key: 'referral_signup_bonus_user', value: 5, category: 'referral', description: 'Signup bonus for new user (INR)' },
